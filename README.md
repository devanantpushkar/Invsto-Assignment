...
Here are some example visualizations generated by the pipeline for Apple Inc. (AAPL):

### Historical Price Analysis
![AAPL History](results/figures/AAPL_history.png)

### Model Predictions

**ARIMA Model**
![AAPL ARIMA Prediction](results/figures/AAPL_ARIMA_prediction.png)

**Gradient Boosting Model**
![AAPL Gradient Boosting Prediction](results/figures/AAPL_GradientBoosting_prediction.png)

### Feature Importance
![AAPL Feature Importance](results/figures/AAPL_feature_importance.png)
